  ...
  const handleTranslateClick = async () => {
    if (translation) {
      ...
      try {
        ...
        // For now, we'll do a simple "mock" translation for testing
        // In production, use the real translation service
        const translated = containsFrench 
          ? `[Translation: ${message.content}]` 
          : `[Traduction: ${message.content}]`;
